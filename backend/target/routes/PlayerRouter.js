...
init();
router.get("/", Auth_1.userAuth, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const token = req.cookies.jwt;
    jwt.verify(token, JWT_SECRET, (err, decodedToken) => __awaiter(void 0, void 0, void 0, function* () {
        if (err) {
            res.send("ERROR");
        }
        else {
